...
function addInfo(data) {
	...
	if (data.response_code == 0) {
		...
		containerII.lastElementChild.innerHTML += `<div class="col-md-6" style="margin: auto;">
			                                            <div class="alert alert-info">
			                                                <div class="alert-body">
			                                            	Sorry... Could not return results. The API does not have enough questions for your query. Make a new query 🤷‍♂️.
														    </div>
														</div>
			                                        </div>`;
	}
...
function validateQuestions() {
	...
	formII.innerHTML = `<div class="col-md-6" style="margin: auto;">
                            <div class="alert alert-info">
                                <div class="alert-body">
		                    	    You have ${account} correct answers out of a total of ${question_correctT.length} questions 🤓.
                                </div>
                            </div>
                        </div>`;
	question_correctT = [];
